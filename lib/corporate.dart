...
class _CorporatePageState extends State<CorporatePage> {
  final Map<String, List<bool>> _selectedImages = {
    ...
    'Activities': List.generate(5, (_) => false),
  ...
  final Map<String, List<int>> _itemCosts = {
    ...
    'Activities': [500, 700, 600, 800, 650],
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            scrollImage(context, 'Activities'),
            const SizedBox(height: 16),
  ...
  Widget scrollImage(BuildContext context, String category) {
    final names = {
      ...
      'Music': ['Gujarati', 'Hindi', 'Marathi', 'Punjabi', 'English'],
      'Activities': ['Award Ceremony', 'Speech', 'Games', 'Music', 'Dance'],
      'Food': ['Punjabi', 'South Indian', 'Non-Veg', 'Indian', 'Italian'],
      'Beverage': ['Cocktails', 'Wine', 'Juice', 'Soda', 'Tea/Coffee'],
      'Desert': ['Cup Cake', 'Pestry', 'Donuts', 'Ice-creme', 'Sweets'],
    };
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildEventCard(
                  'assets/ass1/${category.toLowerCase()}${index + 1}.png',
  ...
  Widget _buildEventCard(
    ...
    return GestureDetector(
      onTap: () {
        if (category == 'Theme' || category == 'Food'|| category == 'Beverage'|| category == 'Desert'|| category == 'Activities'|| category == 'Music'){
          showDialog(
            context: context,
            builder: (context) {
              return Dialog(
      ...
      for (var i = 0; i < _selectedImages[category]!.length; i++) {
        if (_selectedImages[category]![i]) {
          selectedItems.add({
            ...
            'imagePath': 'assets/ass1/${category.toLowerCase()}${i + 1}.png',
          });
