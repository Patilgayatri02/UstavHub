...
class _EngagementPageState extends State<EngagementPage> {
  ...
  Widget scrollImage(BuildContext context, String category) {
    final names = {
      ...
      'Dance': ['Solo', 'Couple', 'Group', 'Free', 'Classical'],
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildEventCard(
                  'assets/engagement/e1/${category.toLowerCase()}${index + 1}.png',
  ...
  Widget _buildEventCard(
    ...
    return GestureDetector(
      onTap: () {
        if (category == 'Theme' || category == 'Food'|| category == 'Beverage'|| category == 'Desert'|| category == 'Dance'|| category == 'Music') {
          showDialog(
            context: context,
            builder: (context) {
              return Dialog(
      ...
      for (var i = 0; i < _selectedImages[category]!.length; i++) {
        if (_selectedImages[category]![i]) {
          selectedItems.add({
            ...
            'imagePath': 'assets/engagement/e1/${category.toLowerCase()}${i + 1}.png',
          });
